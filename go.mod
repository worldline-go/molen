module github.com/worldline-go/molen
...
require (
	...
	github.com/worldline-go/tell v0.5.0
	github.com/worldline-go/tell/metric/metricecho v0.5.0
	github.com/worldline-go/wkafka v0.3.2
